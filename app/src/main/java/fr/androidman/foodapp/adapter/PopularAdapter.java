package fr.androidman.foodapp.adapter;
...
import fr.androidman.foodapp.FoodDetails;
import fr.androidman.foodapp.R;
...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.PopularViewHolder> {
    ...
    public  static class PopularViewHolder extends RecyclerView.ViewHolder{
        ...
        public PopularViewHolder(@NonNull View itemView) {
            ...
            popularName = itemView.findViewById(R.id.popular_name);//all_menu_name
            popularImage = itemView.findViewById(R.id.popular_image);//all_menu_name
